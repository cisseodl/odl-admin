  ...
  return (
    <>
      <Button
        ...
        aria-label={t(isOpen ? "sidebar.closeMenu" : "sidebar.openMenu")}
          ...
          <div className="flex h-16 items-center justify-center border-b px-6">
            ...
            >
              ...
              />
                    ...
                    <nav className="flex-1 px-3 py-4 space-y-3 overflow-y-auto" aria-label={t("sidebar.mainNav")}>
                                                        ...
                                                        return (
                                                          <AccordionItem key={route.label} value={route.label} className="border-b-0 mb-3">
                                                            ...
                                                            <AccordionContent className="pb-1">
                                                              <div className="ml-4 pl-2 border-l border-muted-foreground/20 space-y-3">
